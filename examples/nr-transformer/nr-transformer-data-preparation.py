...
output_df = pd.read_csv('/home/maximilianrosca/ns-3-dev/outputs_DlTransmission.csv') # sed -i 's/,$//' outputs_DlTransmission.csv to remove last empty column
...
padded_input = "/home/maximilianrosca/ns-3-dev/inputs_DlTransmission_padded.csv"
...
# ***********************************************************************
padded_input_df = pd.read_csv('/home/maximilianrosca/ns-3-dev/inputs_DlTransmission_padded.csv')
