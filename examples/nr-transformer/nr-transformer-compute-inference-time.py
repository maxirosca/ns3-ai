...
# # --------------------------- Sort the output CSV by num_parameters and remove duplicates ---------------------------
# df_output = pd.read_csv(output_csv)
# df_output["num_parameters"] = df_output["num_parameters"].str.replace("K", "").astype(float)
# df_output = df_output.sort_values(by=["num_parameters"], ascending=True)
# df_output = df_output.drop_duplicates(subset=["num_parameters"], keep='first')
# df_output.to_csv("model_inference_times_and_parameters_sorted_by_num_parameters.csv", index=False)
# # --------------------------- End of Sort the output CSV by num_parameters and remove duplicates ---------------------------





# # --------------------------- Sort the output CSV by avg_inference_time_ms ---------------------------
# df_output = pd.read_csv(output_csv)
# df_output = df_output.sort_values(by=["avg_inference_time_ms"], ascending=True)
# df_output.to_csv("model_inference_times_and_parameters_sorted_by_avg_inference_time.csv", index=False)
# # --------------------------- End of Sort the output CSV by avg_inference_time_ms ---------------------------





# --------------------------- Calculate average, p95, and p99 inference times for transformer only ---------------------
...
# --------------------------- End of Calculate average, p95, and p99 inference times for transformer only ---------------------





# --------------------------- Calculate average, p95, and p99 inference times for scheduler ---------------------
...
# --------------------------- End of Calculate average, p95, and p99 inference times for scheduler ---------------------





# # --------------------------- Calculate average, p95, and p99 inference times for scheduler averaging over simulations ---------------------
# df_scheduler_inference = pd.read_csv('scheduler_time_dl.csv')
...
# # --------------------------- End of Calculate average, p95, and p99 inference times for scheduler averaging over simulations ---------------------





# # --------------------------- Calculate average inference time for transformer only, divided into 10 sections (simulations) ---------------------
# df_transformer_inference = pd.read_csv('scheduler_time_only_model_inference.csv')
...
# # --------------------------- End of Calculate average inference time for transformer only, divided into 10 sections (simulations) ---------------------





# # ---------------------------- Filter models with avg inference time under 1 ms ---------------------------
# df = pd.read_csv('model_inference_times_and_parameters_sorted_by_avg_inference_time.csv')
# df = df[df["avg_inference_time_ms"] < 1.0]
# df.to_csv('under_1ms_inference_times.csv', index=False)
# # ---------------------------- End of Filter models with avg inference time under 1 ms --------------------------





# # ---------------------------- Print the model with the highest val_acc_symbol_max for a specific configuration ---------------------------
# df = pd.read_csv('training_validation_log_file_combined__sorted_by_max_val_acc_sym.csv')
# df_to_print = df[(df["d_model"] == 32) & (df["nhead"] == 8) & (df["num_layers"] == 1)]
# value_toPrint = df_to_print["val_acc_symbol_max"].max()
# print(df_to_print)
# print(value_toPrint)
# # ---------------------------- End of Print the model with the highest val_acc_symbol_max for a specific configuration ---------------------------